...
pub struct DestroyParticleHook {
    pub direction: AnimationHookDir,
    pub emitter_id: u32,
}

impl DestroyParticleHook {
    pub fn hook_type(&self) -> AnimationHookType {
        AnimationHookType::DESTROY_PARTICLE
    }
}

impl IUnpackable for DestroyParticleHook {
...
impl IPackable for DestroyParticleHook {
