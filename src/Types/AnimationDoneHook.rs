...
pub struct AnimationDoneHook {
    pub direction: AnimationHookDir,
}

impl AnimationDoneHook {
    pub fn hook_type(&self) -> AnimationHookType {
        AnimationHookType::ANIMATION_DONE
    }
}

impl IUnpackable for AnimationDoneHook {
...
impl IPackable for AnimationDoneHook {
