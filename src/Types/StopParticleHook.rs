...
pub struct StopParticleHook {
    pub direction: AnimationHookDir,
    pub emitter_id: u32,
}

impl StopParticleHook {
    pub fn hook_type(&self) -> AnimationHookType {
        AnimationHookType::STOP_PARTICLE
    }
}

impl IUnpackable for StopParticleHook {
...
impl IPackable for StopParticleHook {
