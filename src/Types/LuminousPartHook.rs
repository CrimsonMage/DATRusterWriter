...
impl LuminousPartHook {
    pub fn hook_type(&self) -> AnimationHookType {
        AnimationHookType::LUMINOUS_PART
    }
}

impl IUnpackable for LuminousPartHook {
...
impl IPackable for LuminousPartHook {
