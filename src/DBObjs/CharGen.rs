...
pub const CHAR_GEN_ATTR: DBObjTypeAttribute = DBObjTypeAttribute {
    rust_type_name: "CharGen",
    dat_file_type: DatFileType::Portal,
    db_obj_type: DBObjType::CharGen,
...
impl IUnpackable for CharGen {
    fn unpack(&mut self, reader: &mut DatBinReader<'_>) -> bool {
        ...
        for _ in 0..count {
            self.starting_areas.push(reader.read_item::<StartingArea>());
        }
...
impl IPackable for CharGen {
    fn pack(&self, writer: &mut DatBinWriter<'_>) -> bool {
        ...
        for item in &self.starting_areas {
