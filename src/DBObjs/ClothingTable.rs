...
pub const CLOTHING_TABLE_ATTR: DBObjTypeAttribute = DBObjTypeAttribute {
    rust_type_name: "ClothingTable",
...
pub struct ClothingTable {
    pub base: DBObjBase,
    pub clothing_base_effects: HashTable<QualifiedDataId<Setup>, ClothingBaseEffect>,
    pub clothing_sub_pal_effects: HashTable<u32, CloSubPalEffect>,
}
...
impl IUnpackable for ClothingTable {
    fn unpack(&mut self, reader: &mut DatBinReader<'_>) -> bool {
        ...
        self.clothing_base_effects =
            reader.read_item::<HashTable<QualifiedDataId<Setup>, ClothingBaseEffect>>();
        self.clothing_sub_pal_effects = reader.read_item::<HashTable<u32, CloSubPalEffect>>();
        true
    }
}
