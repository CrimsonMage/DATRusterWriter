...
use crate::{
    ...
    Types::{CombatManeuver::CombatManeuver, DBObj::{DBObj, DBObjBase}},
};
...
impl IUnpackable for CombatTable {
    fn unpack(&mut self, reader: &mut DatBinReader<'_>) -> bool {
        ...
        for _ in 0..count { self.combat_maneuvers.push(reader.read_item::<CombatManeuver>()); }
        true
    }
}
...
impl IPackable for CombatTable {
    fn pack(&self, writer: &mut DatBinWriter<'_>) -> bool {
        ...
        for item in &self.combat_maneuvers { writer.write_item(item); }
        true
    }
}
