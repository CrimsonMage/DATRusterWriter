...
pub const DATA_ID_MAPPER_ATTR: DBObjTypeAttribute = DBObjTypeAttribute {
    rust_type_name: "DataIdMapper",
    dat_file_type: DatFileType::Portal,
    db_obj_type: DBObjType::DataIdMapper,
...
impl IUnpackable for DataIdMapper {
...
impl IPackable for DataIdMapper {
