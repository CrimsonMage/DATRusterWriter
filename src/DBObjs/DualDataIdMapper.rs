...
pub const DUAL_DATA_ID_MAPPER_ATTR: DBObjTypeAttribute = DBObjTypeAttribute {
    rust_type_name: "DualDataIdMapper",
    dat_file_type: DatFileType::Portal,
    db_obj_type: DBObjType::DualDataIdMapper,
...
impl DBObj for DualDataIdMapper {
...
impl IUnpackable for DualDataIdMapper {
...
impl IPackable for DualDataIdMapper {
...
impl IDBObj for DualDataIdMapper {
    fn db_obj_type_attr() -> &'static DBObjTypeAttribute
    where
        Self: Sized,
    {
        &DUAL_DATA_ID_MAPPER_ATTR
    }
    fn db_obj_type(&self) -> DBObjType {
        DBObjType::DualDataIdMapper
    }
