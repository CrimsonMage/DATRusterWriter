...
use crate::{
    ...
    Generated::Enums::{DBObjHeaderFlags::DBObjHeaderFlags, DBObjType::DBObjType, DatFileType::DatFileType, SurfaceType::SurfaceType},
    ...
    Types::{ColorARGB::ColorARGB, DBObj::{DBObj, DBObjBase}, QualifiedDataId::QualifiedDataId},
};

pub const SURFACE_ATTR: DBObjTypeAttribute = DBObjTypeAttribute { rust_type_name: "Surface", dat_file_type: DatFileType::Portal, db_obj_type: DBObjType::Surface, header_flags: DBObjHeaderFlags::None, first_id: 0x08000000, last_id: 0x0800FFFF, mask_id: 0x08000000 };
...
impl DBObj for Surface {
    ...
    fn db_obj_type(&self) -> DBObjType { DBObjType::Surface }
...
impl IUnpackable for Surface {
    fn unpack(&mut self, reader: &mut DatBinReader<'_>) -> bool {
        ...
        if self.surface_type.intersects(SurfaceType::Base1Image | SurfaceType::Base1ClipMap) {
...
impl IDBObj for Surface {
    fn db_obj_type_attr() -> &'static DBObjTypeAttribute where Self: Sized { &SURFACE_ATTR }
    fn db_obj_type(&self) -> DBObjType { DBObjType::Surface }
    fn id(&self) -> u32 { self.base.id }
    fn set_id(&mut self, id: u32) { self.base.id = id; }
