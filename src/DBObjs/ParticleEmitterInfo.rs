...
pub const PARTICLE_EMITTER_INFO_ATTR: DBObjTypeAttribute = DBObjTypeAttribute {
    rust_type_name: "ParticleEmitterInfo",
...
impl DBObj for ParticleEmitterInfo {
...
impl IUnpackable for ParticleEmitterInfo {
...
impl IPackable for ParticleEmitterInfo {
...
impl IDBObj for ParticleEmitterInfo {
    fn db_obj_type_attr() -> &'static DBObjTypeAttribute
    where
        Self: Sized,
    {
        &PARTICLE_EMITTER_INFO_ATTR
    }
    fn db_obj_type(&self) -> DBObjType {
        DBObjType::ParticleEmitter
    }
